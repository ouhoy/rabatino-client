...
async function fetchRestaurantData() {
  try {
    ...
    fetchError.value = 'Failed to load restaurant data. Please try again.'
  } finally {
...
const formState = ref({
  ...
  takeout: false, // Fix the property name (was takout)
  delivery: false
})
...
// Modify handleSubmit to use PUT method
const handleSubmit = async () => {
  ...
  try {
    ...
    const restaurantData = {
      ...
      takeout: formState.value.takeout, // Fix the property name
