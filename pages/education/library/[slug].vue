...
const library = ref<Library>({
  ...
  description: 'A modern library offering extensive collections, digital resources, and comfortable study spaces for all visitors.',
  images: ['/images/library-main.jpg'],
  createdAt: new Date(),
  userId: '1',
  address: '789 Library Street, Knowledge District, City, 12345',
  latitude: 40.7128,
  longitude: -74.0060,
  website: 'www.centrallibrary.edu',
  phone: '+1 (555) 456-7890',
  email: 'info@centrallibrary.edu',
  ...
  operationHours: '8:00 AM - 8:00 PM',
  hasPrinting: true,
  hasStudyRooms: true
});
  ...
  <main class="w-full flex flex-col items-center justify-center gap-10 mb-28 lg:my-10">
    ...
    <section v-if="!pending" class="w-full flex flex-col gap-6 items-start justify-center">
      ...
      <div class="w-full bg-neutral-300 rounded-2xl h-96">
        <!-- Add map component here using library.latitude and library.longitude -->
      </div>
    </section>
  </main>
</template>
